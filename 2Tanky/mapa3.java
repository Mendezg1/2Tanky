...
/**
 * Write a description of class mapa3 here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class mapa3 extends World
{

    Victorias cont = new Victorias();
    public Tank1 tanquev = new Tank1();
    public Tank2 tanquea = new Tank2();
    public mapa3(int verde, int azul, int rondas, int rondasf)
    {    
        super(1300, 700, 1); 
    ...
    private void prepare()
    {
        ...
        tank1.setLocation(44,276);
        tank2.setLocation(56,83);
        tank1.setLocation(1078,76);
    }
        ...
        if(this.getObjects(explosion.class).size() != 0){
            if(this.getObjects(Tank1.class).size() != 0){
                ...
                if (ganador){
                    ...
                    Greenfoot.setWorld(new mapa4(verde,azul,rondas,rondasf));
                }
            }
            else {
                cont.masazul();
